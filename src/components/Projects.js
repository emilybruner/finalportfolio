            ...
            <div class='projects-container'>
                <div class='project-box'>
                    <div class='project-image-container'>
                        <img src={kansha} alt='gift box' class='project-pic'/>
                    </div>
                    <div class='project-summary-container'>
                        <h6 class='project-title'>Kansha Rewards</h6>
                        <p class ='project description'> A workplace recognition platform to appreciate peers through rewards and in-app messages. This was a build-on project where we completely overhauled the back end and front end to handle multiple user types and created the feature of organization accounts and administrator tools for monitoring employee activity and recognition.</p>
                        <p class='techstack'>Tech Stack:</p>
